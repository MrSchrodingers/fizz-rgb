...
export function ParametersPanel({ onApply }: { onApply: () => void }) {
  ...
  if (selected === 'solid-color') {
    return (
      <section className="p-6 flex flex-col gap-4 min-w-[260px] w-72 h-full overflow-y-auto">
  ...
  return (
    <section className="p-6 flex flex-col gap-5 min-w-[260px] w-72 h-full overflow-y-auto">
